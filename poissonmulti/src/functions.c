...
void pmd_simulation(double *res0, int *nnt, int *nn, int *mm, double *pp, int *nn_vec, int *l_vec, int *cn_vec, double *t)
{
  int nt,i,j,k;
...
//*****************************************************************************//
void pmd_simulation_vec(double *res0, int *nn, int *mm, double *pp, int *x_vec, double *t)
{
  int i,j,k;
  const unsigned int d=t[0];
  const unsigned int sum_n = BINS;
