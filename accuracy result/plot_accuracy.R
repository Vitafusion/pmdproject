...
dat.simu %>% filter(B==10|B==10000|B==1e+07) %>% ggplot() + 
...
dat.simu %>% filter(n<40) %>% filter(B==10|B==10000|B==1e+07) %>% ggplot() + 
...
dat.simu %>% filter(n<30) %>% filter(B==10|B==10000|B==1e+07) %>% ggplot() + 
